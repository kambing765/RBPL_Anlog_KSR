                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="title-heading text-center">
                            <h4 class="heading text-white mb-4">Korps Sukarela  </h4>
                            <p class="text-white-50 para-desc mx-auto mb-0">Organisasi dibawah Palang Merah Indonesia yang mengumpulkan para sukarelawan yang ingin membantu mereka yang membutuhkan.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
