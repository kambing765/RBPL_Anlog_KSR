            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="title-heading text-center">
                        <h4 class="heading text-white mb-4">Input Jadwal</h4>
                        ...
                        <div class="row align-items-center">
                            <div class="col-12 mt-4 pt-2">
                                <form method="POST" action="update_jadwal.php">
                                    ...
                                    Nomor Tugas: <input type="int" name="no_tugas"><br><br>
                                    Tugas: <input type="text" name="tugas"><br><br>
                                    Pengawas: <select name="user_id0">
                                        <?php $query2 = mysqli_query($konek, "select id as user_id0, nama from user");
                                        while ($data2 = mysqli_fetch_array($query2)) { ?>
                                            <option value="<?php echo $data2['user_id0']; ?>"><?php echo $data2['nama']; ?></option><?php } ?>
                                    </select> <br><br>
                                    Petugas 1: <select name="user_id1">
                                        <?php $query2 = mysqli_query($konek, "select id as user_id1, nama from user");
                                        while ($data2 = mysqli_fetch_array($query2)) { ?>
                                            <option value="<?php echo $data2['user_id1']; ?>"><?php echo $data2['nama']; ?></option><?php } ?>
                                    </select> <br><br>
                                    Petugas 2: <select name="user_id2">
                                        <?php $query2 = mysqli_query($konek, "select id as user_id2, nama from user");
                                        while ($data2 = mysqli_fetch_array($query2)) { ?>
                                            <option value="<?php echo $data2['user_id2']; ?>"><?php echo $data2['nama']; ?></option><?php } ?>
                                    </select> <br><br>
                                    Petugas 3: <select name="user_id3">
                                        <?php $query2 = mysqli_query($konek, "select id as user_id3, nama from user");
                                        while ($data2 = mysqli_fetch_array($query2)) { ?>
                                            <option value="<?php echo $data2['user_id3']; ?>"><?php echo $data2['nama']; ?></option><?php } ?>
                                    </select> <br><br>
                                    Petugas 4: <select name="user_id4">
                                        <?php $query2 = mysqli_query($konek, "select id as user_id4, nama from user");
                                        while ($data2 = mysqli_fetch_array($query2)) { ?>
                                            <option value="<?php echo $data2['user_id4']; ?>"><?php echo $data2['nama']; ?></option><?php } ?>
                                    </select> <br><br>
                                    Petugas 5: <select name="user_id5">
                                        <?php $query2 = mysqli_query($konek, "select id as user_id5, nama from user");
                                        while ($data2 = mysqli_fetch_array($query2)) { ?>
                                            <option value="<?php echo $data2['user_id5']; ?>"><?php echo $data2['nama']; ?></option><?php } ?>
                                    </select> <br><br>
                                    Jadwal: <input type="date" name="jadwal"><br><br>
