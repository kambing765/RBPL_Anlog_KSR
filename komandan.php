...
<!-- START NAVBAR -->
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="title-heading text-center">
                            <h4 class="heading text-white mb-4">Page Komandan</h4>
                        </div>
                </div><!--end col-->
            </div><!--end row-->
        </div><!--end container-->
    ...
    <div class="container text-center"><br>
        ...
        <div class="text-start">
            <br><a href="input_jadwal.php?jabatan=komandan"><button class="btn btn-success">New</button></a>
        </div>
        ...
        <table class="table table-striped table-hover table-bordered">
            ...
            <tbody class="table-group-divider">
                ...
                inner JOIN user as u5 ON u5.id = j.user_id5 order by j.no_tugas ;");
                while ($data = mysqli_fetch_array($query)) { ?>
                    <tr class="table-secondary">
                        ...
                        <td>
                            <a href="edit_jadwal.php?id=<?php echo $data['id']; ?>&&jabatan=komandan"><button class="btn btn-primary">Edit</button></a>
                            <a href="delete.php?id=<?php echo $data['id']; ?>&&jabatan=komandan&&table=jadwal"><button class="btn btn-danger">Hapus</button></a>
                        </td>
                    <?php }
                    ?>
                    </tr>
        ...
        <h2>Peminjaman</h2>
        <div class="text-start">
            <br><a href="input_pinjam.php?jabatan=komandan"><button class="btn btn-success">New</button></a>
        </div><br>
        <table class="table table-striped table-hover table-bordered">
            <thead>
                <tr class="table-danger">
            ...
            <tbody class="table-group-divider">
                ...
                while ($data = mysqli_fetch_array($query)) { ?>
                    <tr class="table-secondary">
                        ...
                        <td><?php echo $data['status']; ?></td>
                        <td>
                            <a href="edit_pinjam.php?no_pinjam=<?php echo $data['no_pinjam']; ?>&&jabatan=komandan"><button class="btn btn-primary">edit</button></a>
                            <a href="delete.php?id=<?php echo $data['id']; ?>&&jabatan=komandan&&table=pinjam"><button class="btn btn-danger">hapus</button></a>
                        </td>
                    <?php }
                    ?>
                    </tr>
        ...
        <h2>Dokumentasi</h2>
        <div class="text-start">
            <br><a href="input_dokumentasi.php?jabatan=komandan"><button class="btn btn-success">New</button></a>
        </div><br>
        <table class="table table-striped table-hover table-bordered">
            <thead>
                <tr class="table-danger">
            ...
            <tbody class="table-group-divider">
                ...
                while ($data = mysqli_fetch_array($query)) { ?>
                    <tr class="table-secondary">
                        ...
                        <td>
                            <a href="edit_dokumentasi.php?id=<?php echo $data['id']; ?>&&jabatan=komandan"><button class="btn btn-primary">edit</button></a>
                            <a href="delete.php?id=<?php echo $data['id']; ?>&&jabatan=komandan&&table=dokumentasi"><button class="btn btn-danger">hapus</button></a>
                        </td>
                    <?php }
                    ?>
                    </tr>
        ...
        <h2>User</h2>
        <div class="text-start">
            <br><a href="input_user.php?jabatan=komandan"><button class="btn btn-success">New</button></a>
        </div><br>
        <table class="table table-striped table-hover table-bordered">
            <thead>
                <tr class="table-danger">
            ...
            <tbody class="table-group-divider">
                ...
                while ($data = mysqli_fetch_array($query)) { ?>
                    <tr class="table-secondary">
                        ...
                        <td>
                            <a href="edit_user.php?id=<?php echo $data['id']; ?>&&jabatan=komandan"><button class="btn btn-primary">edit</button></a>
                            <a href="delete.php?id=<?php echo $data['id']; ?>&&jabatan=komandan&&table=user"><button class="btn btn-danger">hapus</button></a>
                        </td>
                    <?php }
                    ?>
                    </tr>
