...
<body>
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="title-heading text-center">
                        <h4 class="heading text-white mb-4">Page Kasi</h4>
                    </div>
                </div><!--end col-->
            </div><!--end row-->
        </div><!--end container-->
    ...
    <div class="container text-center">
        ...
        <div class="text-start">
            <br><a href="input_pinjam.php?jabatan=kasi"><button class="btn btn-success">New</button></a>
        </div><br>
            ...
            <tbody class="table-group-divider">
                ...
                while ($data = mysqli_fetch_array($query)) { ?>
                    <tr class="table-secondary">
                        ...
                        <td>
                            <a href="edit_pinjam.php?no_pinjam=<?php echo $data['no_pinjam']; ?>&&jabatan=kasi"><button class="btn btn-primary">edit</button></a>
                            <a href="delete.php?id=<?php echo $data['id']; ?>&&jabatan=kasi&&table=pinjam"><button class="btn btn-danger">hapus</button></a>
                        </td>
                    <?php }
                    ?>
                    </tr>
        ...
        <h2>User</h2>
        <div class="text-start">
            <br><a href="input_user.php?jabatan=kasi"><button class="btn btn-success">New</button></a>
        </div><br>
        <table class="table table-striped table-hover table-bordered">
            <thead>
                <tr class="table-danger">
            ...
            <tbody class="table-group-divider">
                ...
                while ($data = mysqli_fetch_array($query)) { ?>
                    <tr class="table-secondary">
                        ...
                        <td>
                            <a href="edit_user.php?id=<?php echo $data['id']; ?>&&jabatan=kasi"><button class="btn btn-primary">edit</button></a>
                            <a href="delete.php?id=<?php echo $data['id']; ?>&&jabatan=kasi&&table=user"><button class="btn btn-danger">hapus</button></a>
                        </td>
                    <?php }
                    ?>
                    </tr>
